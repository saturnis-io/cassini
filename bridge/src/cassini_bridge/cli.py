"""Cassini Bridge CLI — RS-232/USB gage to MQTT bridge agent."""
import argparse
import sys
...
def cmd_run(args):
    ...
    from cassini_bridge.runner import run_bridge
...
def main():
    ap = argparse.ArgumentParser(prog="cassini-bridge", description="Cassini Gage Bridge Agent")
    ...
    rp.add_argument("--server", help="Cassini SPC server URL")
