...
from cassini.core.anomaly.feature_builder import FEATURE_NAMES, build_features
from cassini.core.anomaly.model_store import load_model_state, save_model_state
    ...
    async def _retrain(
        ...
        try:
            ...
            logger.warning(
                ...
                char_id=char_id,
                msg="Install scikit-learn for Isolation Forest support: pip install cassini[ml]",
            )
            return
