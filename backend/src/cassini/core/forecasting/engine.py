...
from cassini.core.forecasting.arima import (
    ARIMAForecaster,
    ForecastingUnavailable,
    ForecastResult,
)
from cassini.core.forecasting.exponential_smoothing import (
...
class ForecastingEngine:
    ...
    async def _process_sample(
        ...
        from cassini.db.models.prediction import PredictionConfig, PredictionModel
    ...
    async def _retrain_and_forecast(
        ...
        from cassini.db.models.prediction import Forecast, PredictionModel
    ...
    async def generate_forecast(
        ...
        """
        from cassini.db.models.prediction import (
            Forecast,
            PredictionConfig,
        )
