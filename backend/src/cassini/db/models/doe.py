...
class DOEAnalysis(Base):
    ...
    pred_r_squared: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    lack_of_fit_f: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    lack_of_fit_p: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
