...
- Integration with Cassini violation events
...
from cassini.mqtt.client import MQTTClient
...
class SparkplugDecoder:
    ...
    def _decode_protobuf(
        ...
        Returns:
            Tuple of (timestamp, metrics_list, sequence_number)
        """
        from cassini.mqtt.sparkplug_b_pb2 import Payload
...
class SparkplugAdapter:
    """Adapts between Cassini events and Sparkplug B messages.

    Provides high-level integration between the Cassini event system and
