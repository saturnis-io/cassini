...
class AIProviderConfig(Base):
    ...
    use :func:`openspc.db.dialects.encrypt_password` and
    :func:`openspc.db.dialects.decrypt_password` with
    :func:`openspc.db.dialects.get_encryption_key` at the API layer.
