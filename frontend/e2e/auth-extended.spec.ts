/**
 * Auth/Security Features — E2E Tests
 *
 * Tests:
 ...
 *   - seed_e2e.py run (Tests plant with locked/deactivated users)
 */
...
test.describe('Auth/Security Features', () => {
  ...
  test.beforeAll(async ({ request }) => {
    ...
    lockedUserId = manifest.extended.locked_user_id
    deactivatedUserId = manifest.extended.deactivated_user_id
  })
