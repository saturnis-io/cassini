/**
 * Sprint 15 — Time-travel replay scrubber (Pro+ tier feature).
 *
 * The original `replay.spec.ts` covers the slider drag and exit flow.
 * This spec is the additional Sprint 15 acceptance: the scrubber lives on
...
test.describe('Sprint 15 Replay Scrubber', () => {
