            ...
            <div className="text-sm text-muted-foreground">
              {selectedChar.data_type === 'attribute' ? (
                <>
                  ...
                  {selectedChar.default_sample_size != null && ` | Default sample size: ${selectedChar.default_sample_size}`}
                </>
              ) : (
                <>
          ...
          {selectedChar.data_type === 'attribute' ? (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <div className="font-medium">{selectedChar.attribute_chart_type?.toUpperCase() ?? '-'}-chart</div>
              </div>
              <div>
