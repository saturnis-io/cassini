...
export function RetentionOverridePanel({
  ...
  const isInherited =
    effectiveStep?.nodeId !== selectedNode?.id || effectiveStep?.nodeType === 'plant'
  ...
  return (
    <div className="space-y-5 p-5" key={nodeKey}>
      {/* Header */}
      <div>
        <p className="text-muted-foreground text-xs">{fullBreadcrumb}</p>
          ...
          <RetentionPolicyForm
            initialPolicy={
              nodeOverride
                ? {
                    retention_type:
                      nodeOverride.retention_type as RetentionPolicySet['retention_type'],
                    retention_value: nodeOverride.retention_value,
                    retention_unit:
                      nodeOverride.retention_unit as RetentionPolicySet['retention_unit'],
                  }
                : undefined
            }
      ...
      {showClearConfirm && (
        ...
        >
          ...
          >
            <h3 className="mb-2 text-lg font-semibold">Remove Override</h3>
