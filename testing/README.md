# Cassini Verification Checklists
...
1. Set `CASSINI_SANDBOX=true` in your environment or `.env` file
...
- **Sandbox mode**: `CASSINI_SANDBOX=true` environment variable must be set
...
See [GitHub Issues](https://github.com/saturnis-io/cassini/issues) for the
complete feature list, priorities, and sprint assignments.
