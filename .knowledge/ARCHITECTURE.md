...
- **analytics**: Multivariate SPC, predictions, DOE, correlation, AI analysis (Sprint 9)
...
erDiagram
    ...
    Characteristic ||--o| PredictionConfig : "forecasted by"
    ...
    ERPConnector }o--|| Plant : "per plant"
```
...
flowchart LR
    ...
    EB -->|login/logout| S3
    EB -->|ViolationCreatedEvent| S4
    EB -->|SampleProcessedEvent| S5
```
