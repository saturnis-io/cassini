...
8. **Your Tasks**: Run `**[List Tasks via MCP]** Use the `cvc_task_list` tool to see all current tasks.` to see assigned tasks
...
---
*Transpiled from: skills/company-developer/SKILL.md*