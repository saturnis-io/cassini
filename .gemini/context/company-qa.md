...
# Read: .company/artifacts/ui-designer/accessibility-ux.md
# Read: .company/artifacts/qa/qa-report.md
```

### Check Inbox
Look for messages in: `.company/inboxes/qa/`
...
10. **Your Tasks**: Run `**[List Tasks via MCP]** Use the `cvc_task_list` tool to see all current tasks.` to see assigned tasks
...
---
*Transpiled from: skills/company-qa/SKILL.md*