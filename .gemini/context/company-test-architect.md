...
# Read: .company/artifacts/test-architect/test-strategy.md
# Read: .company/artifacts/test-architect/test-report.md
```
...
---
*Transpiled from: skills/company-test-architect/SKILL.md*