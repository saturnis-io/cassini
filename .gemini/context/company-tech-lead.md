...
# Read: .company/artifacts/architect/[file].md
# Read: .company/artifacts/ui-designer/[file].md
# Read: >
# Read: .company/artifacts/architect/component-design.md
# Read: .company/artifacts/architect/api-contracts.md
# Read: .company/artifacts/ui-designer/ui-wireframes.md
# Read: .company/artifacts/ui-designer/design-system.md
# Read: .company/artifacts/tech-lead/feature-spec.md
# Read: .company/artifacts/tech-lead/handoff-implementation.md
# Read: .company/artifacts/tech-lead/task-breakdown.md
```

### Check Inbox
Look for messages in: `.company/inboxes/tech/`
...
7. **Current Tasks**: Run `**[List Tasks via MCP]** Use the `cvc_task_list` tool to see all current tasks.` to see current tasks
...
```
**[Update Task via MCP]** Use the `cvc_task_update` tool:
```
{
  taskId: "T1.2",
  addBlockedBy: ["T1.1"]
...
---
*Transpiled from: skills/company-tech-lead/SKILL.md*