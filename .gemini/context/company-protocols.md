...
# Read: FILE
# Read: >
# Read: .company/sync-state.json
# Read: .company/governance-matrix.json
# Read: .company/artifacts/architect/handoff.md
```
...
---
*Transpiled from: skills/company-protocols/SKILL.md*