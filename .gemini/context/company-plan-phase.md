...
Create executable PLAN.md for phase {{args}} using goal-backward methodology.
...
> Research implementation approach for phase {{args}}. Analyze codebase patterns, relevant files, and technical considerations. Context: {from CONTEXT.md}

After completion, read any artifacts produced by this role.

```

Capture in `.planning/phase-{{args}}/RESEARCH.md`
...
Write to `.planning/phase-{{args}}/1-PLAN.md`
...
**Execute Phase {{args}}** — Run plans with parallel waves
...
---
*Transpiled from: skills/company-plan-phase/SKILL.md*