...
# Read: .company/audit/interactions.json
...
3. **Active Tasks**: Run `**[List Tasks via MCP]** Use the `cvc_task_list` tool to see all current tasks.` to see current work
...
---
*Transpiled from: skills/company-reply/SKILL.md*