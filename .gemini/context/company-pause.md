...
2. **Active Tasks**: Run `**[List Tasks via MCP]** Use the `cvc_task_list` tool to see all current tasks.` to see current tasks
...
---
*Transpiled from: skills/company-pause/SKILL.md*