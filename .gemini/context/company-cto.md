...
# Read: >
# Read: .company/artifacts/cto/handoff-architecture.md
# Read: .company/artifacts/cto/architecture-decision-record.md
# Read: .company/artifacts/cto/constraints.md
# Read: .company/artifacts/cto/risks.md
```

### Check Inbox
Look for messages in: `.company/inboxes/cto/`
...
---
*Transpiled from: skills/company-cto/SKILL.md*